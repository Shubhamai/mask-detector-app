...
# Built With
- Streamlit --- The completele fronted is based on React Web Application, and streamlit allows to make React Web Application completely in Python 🎉.  
- Sqlite3 --- For saving the user data in a database ( username & password )
- Tensorflow & OpenCV --- To detct faces % mask in **real-time**
